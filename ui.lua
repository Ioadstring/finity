...
finity.dark_theme = { -- dark
	...
	checkbox_checked = Color3.fromRGB(211, 79, 110),
	checkbox_outer = Color3.fromRGB(51, 51, 51),
	checkbox_inner = Color3.fromRGB(38, 38, 38),

	slider_color = Color3.fromRGB(211, 79, 110),
	slider_color_sliding = Color3.fromRGB(158, 58, 82),
	slider_background = Color3.fromRGB(38, 38, 38),
	slider_text = Color3.fromRGB(69, 69, 69),

	textbox_background = Color3.fromRGB(31, 31, 31),
	textbox_background_hover = Color3.fromRGB(38, 38, 38),
	textbox_text = Color3.fromRGB(69, 69, 69),
	textbox_text_hover = Color3.fromRGB(232, 232, 232),
	textbox_placeholder = Color3.fromRGB(232, 232, 232),

	dropdown_background = Color3.fromRGB(38, 38, 38),
	dropdown_text = Color3.fromRGB(69, 69, 69),
